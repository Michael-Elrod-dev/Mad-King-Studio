    ...
    try {
      ...
      if (isEmailJSConfigured()) {
        ...
        setFormState({
          ...
          isSubmitted: true,
          error: null,
          success: 'Form submitted successfully! However, email notifications are not configured yet.',
        });
      }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Have questions about the project? Want to collaborate? Or just want to say hi?
              Shoot me a message below or at one of the given links.
            </p>
          </div>
            ...
            <div className="bg-neutral-800 rounded-lg p-8">
              ...
              {!isEmailJSConfigured() && !formState.isSubmitted && (
                <div className="mb-6 p-4 bg-yellow-600 text-white rounded-lg text-sm">
                  Email notifications are not configured yet. Form submissions will be logged but no email will be sent.
                </div>
              )}
            ...
            <div className="space-y-8">
              ...
              <div className="bg-neutral-800 rounded-lg p-6">
                ...
                <p className="text-white/90 mb-4">
                  I typically respond to messages within 24-48 hours. For urgent stuff,
                  you can reach out via Discord or check if im live.
                </p>
              </div>

              <div className="bg-neutral-800 rounded-lg p-6">
                <h3 className="text-xl font-bold text-white mb-4">Prefer Live Chat?</h3>
                <p className="text-white/90 mb-4">
                  Join me during live development streams! It&apos;s the best way to ask
                  questions and get real-time answers about the game development process.
                </p>
                <a
                  href="/community"
