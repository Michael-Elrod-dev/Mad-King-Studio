...
export default function ContactPage() {
  ...
  // Initialize as null to prevent flash
  ...
  // Show loading state until email configuration is determined
                ...
                <div className="bg-neutral-800 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center text-white/90 hover:text-red-600 transition-colors"
                    >
                      <svg
                        className="w-5 h-5 mr-3"
                        fill="currentColor"
